        ...
        <div class="row">
            <div class="col-md-12" style="margin: auto; background: white; padding: 20px; box-shadow: 10px 10px 5px #888">
                <div class="panel-heading">
                    <h2><a href="https://localhost/sourcecode/index.php">Google Cloud Vision API</a></h2>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-md-8 border" style="padding: 10px;">
                        ...
                        <li class="nav-item">
                                <a href="#pills-object" role="tab" class="nav-link active" id="pills-object-tab" data-toggle="pill" aria-controls="pills-object" aria-selected="true">Objects</a>
                            </li>
                            <li class="nav-item">
