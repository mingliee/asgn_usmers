...
$retrieveReportTicketSQL="SELECT COUNT(*) AS NUM,'ALL' AS CATEGORY FROM REPORT 
INNER JOIN USER ON (REPORT.REPORTED_BY_USER_ID=USER.USER_ID )
UNION SELECT COUNT(*) AS NUM,'OPEN' AS CATEGORY FROM REPORT 
INNER JOIN USER ON (REPORT.REPORTED_BY_USER_ID=USER.USER_ID ) WHERE REPORT.STATUS LIKE 'OPEN'
UNION SELECT COUNT(*) AS NUM,'PROGRESS' AS CATEGORY FROM REPORT 
INNER JOIN USER ON (REPORT.REPORTED_BY_USER_ID=USER.USER_ID ) WHERE REPORT.STATUS LIKE 'PROGRESS'
UNION SELECT COUNT(*) AS NUM,'ON HOLD' AS CATEGORY FROM REPORT 
INNER JOIN USER ON (REPORT.REPORTED_BY_USER_ID=USER.USER_ID ) WHERE REPORT.STATUS LIKE 'ON HOLD'
UNION SELECT COUNT(*) AS NUM,'REJECTED' AS CATEGORY FROM REPORT 
INNER JOIN USER ON (REPORT.REPORTED_BY_USER_ID=USER.USER_ID ) WHERE REPORT.STATUS LIKE 'REJECTED'
UNION SELECT COUNT(*) AS NUM,'CLOSED' AS CATEGORY FROM REPORT 
INNER JOIN USER ON (REPORT.REPORTED_BY_USER_ID=USER.USER_ID ) WHERE REPORT.STATUS LIKE 'CLOSED'";
      ...
      <div class="card-body">
        <div class="d-sm-flex pb-4 mb-4 border-bottom">
          <div class="d-flex align-items-center">
            <h5 class="page-title mb-n2">Report Tickets</h5>
