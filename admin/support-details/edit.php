...
<body>
  ...
  $q1 ="SELECT * FROM `SUPPORT` 
            WHERE SUPPORT.SUPPORT_ID='$supportID'";
...
?>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <label>Comment: </label>
            <textarea class="form-control" name="supportComment" placeholder="Comment..." rows="4">
              <?php echo $comment;?>
            </textarea>
          </div>
          <div class="padTop">
          <input name="supportID" value=<?php echo $supportID;?> type="text" hidden>
          <input type="submit" class="btn btn-gradient-primary mr-2" name="updateSupport_btn" id="updateSupport_btn" value="Update"/>
          <button class="btn btn-light" onClick="window.location.href='../support-details.php?supportID=<?php echo $supportID?>';return false;">Cancel</button>
          </div>
        </form>
      </div>
    </div>
  ...
  <script>
      function goBack(supportID) {
          var supportID=supportID;
          alert('supportID: '+supportID);
        window.location.href='support-details.php?supportID='+supportID;
    }
